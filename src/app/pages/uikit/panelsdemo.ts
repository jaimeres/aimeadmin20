...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ToolbarModule, ButtonModule, SplitButtonModule, AccordionModule, FieldsetModule, MenuModule, InputTextModule, DividerModule, SplitterModule, PanelModule, TabsModule, IconFieldModule, InputIconModule],
  template: `
