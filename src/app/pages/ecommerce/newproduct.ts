      ...
      <p-fluid class="grid grid-cols-12 gap-4 flex-wrap">
        ...
        <div class="col-span-12 lg:col-span-4 flex flex-col gap-y-4">
          ...
          <div class="border border-surface-200 dark:border-surface-700 rounded">
            ...
            <div class="p-4 flex">
              <div *ngFor="let color of colorOptions" class="w-8 h-8 mr-2 border border-surface-200 dark:border-surface-700 rounded-full cursor-pointer flex justify-center items-center" [class]="color.background" (click)="onColorSelect(color.name)">
