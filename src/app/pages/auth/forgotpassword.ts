      ...
      <div class="flex flex-1 flex-col bg-surface-50 dark:bg-surface-950 items-center justify-center">
        <div class="w-11/12 sm:w-120">
          <div class="flex flex-col">
            ...
            <div class="mt-6">
              <h1 class="m-0 text-primary font-semibold text-4xl">¿Olvidaste tu contraseña?</h1>
              <span class="block text-surface-700 dark:text-surface-100 mt-2">Por favor, introduce tu dirección de correo electrónico</span>
            </div>
          </div>
          <div class="flex flex-col gap-4 mt-12">
            <p-input-group>
              ...
              <input pInputText placeholder="Correo electrónico" />
            </p-input-group>
            <p-input-group>
              <button pButton class="w-full" label="ENVIAR CORREO"></button>
            </p-input-group>
            <p-input-group>
              <button pButton [routerLink]="['/auth/login']" class="w-full text-primary-500" text label="VOLVER AL INICIO"></button>
            </p-input-group>
          </div>
        </div>
      </div>
