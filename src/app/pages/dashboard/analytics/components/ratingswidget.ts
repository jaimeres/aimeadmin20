      ...
      datasets: [
        {
          ...
          backgroundColor: [this.layoutService.isDarkTheme() ? `color-mix(in srgb, ${getComputedStyle(document.body).getPropertyValue('--p-primary-200')}, transparent 84%)` : getComputedStyle(document.body).getPropertyValue('--p-primary-50')],
          borderWidth: 2,
          fill: true,
          tension: 0.4
        }
