            ...
            <div id="op" class="card absolute shadow-md rounded-md! border border-gray-100 dark:border-gray-600! hidden!" style="right: 50px; top:45px;">
              <div class="grid grid-cols-12 gap-4 flex-col w-60">
                <div class="col-span-12 flex flex-col">
                  ...
                  <span pRipple class="text-surface-700 dark:text-surface-100 block p-2 cursor-pointer hover:bg-surface-50 dark:hover:bg-surface-950 select-none rounded-border" *ngFor="let list of listNames" (click)="onMove(list.listId || '')">{{
                    list.title
                  }}</span>
                </div>
                <div class="col-span-12 flex flex-col">
