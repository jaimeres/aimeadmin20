        ...
        <div *ngFor="let message of user.messages">
          <div *ngIf="message.ownerId !== 123" class="grid gap-4 grid-nogutter mb-6">
            ...
            <div class="col mt-4">
              ...
              <span class="text-surface-700 dark:text-surface-100 inline-block font-medium border border-surface-200 dark:border-surface-700 p-4 whitespace-normal rounded" style="word-break: break-word; max-width:80%;">{{ message.text }}</span>
          ...
          <div *ngIf="message.ownerId === defaultUserId" class="grid gap-4 grid-nogutter mb-6">
            <div class="col mt-4 text-right">
              <span class="inline-block text-left font-medium border border-surface-200 dark:border-surface-700 bg-primary-100 text-primary-900 p-4 whitespace-normal rounded" style="word-break: break-word; max-width:80%;">{{ message.text }}</span>
