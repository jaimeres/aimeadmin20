...
Esta regla es global para Claude Code en este repositorio. No depende de skills.
...
Antes de proponer o implementar, Claude Code debe localizar y verificar los
...
mecanismo aplicable la propuesta debe salir del diseño actual, Claude Code debe
...
Cuando el usuario pida corregir una condicion o bloque especifico, Claude debe modificar unicamente esa unidad minima.
